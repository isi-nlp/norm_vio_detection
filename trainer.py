...
class Trainer:
    def __init__(self, args):
        ...
        train_loader = data_loader(model_name=args.model_name,
                                   phase='train',
        ...
        val_loader = data_loader(model_name=args.model_name,
                                   phase='dev',
        ...
        test_loader = data_loader(model_name=args.model_name,
                                   phase='test',
                                   batch_size=2*args.batch_size,
                                   max_context_size=args.max_context_size,
                                   max_n_tokens=args.max_n_tokens,
    ...
    def train(self):
        ...
        torch.save(best_state_dict, f"{self.prefix}/model_{self.args.idx}.pt")
